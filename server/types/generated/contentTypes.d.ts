...
export interface ApiAllPageAllPage extends Struct.SingleTypeSchema {
  collectionName: 'all_pages';
  info: {
    description: '';
    displayName: 'All Page';
    pluralName: 'all-pages';
    singularName: 'all-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Home: Schema.Attribute.Component<'all-page.all-page', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::all-page.all-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiBlogCategoryBlogCategory
  ...
  attributes: {
    blog: Schema.Attribute.Relation<'oneToMany', 'api::blog.blog'>;
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    categoryName: Schema.Attribute.Relation<
      'manyToOne',
      'api::blog-category.blog-category'
    >;
    ...
    metaTags: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiBrandBrand extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    brandNname: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    card: Schema.Attribute.Component<'page-component.card', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    workingDaysAndHours: Schema.Attribute.Text;
  };
}
...
export interface ApiOurTeamOurTeam extends Struct.SingleTypeSchema {
  ...
  attributes: {
    AboutArea: Schema.Attribute.Component<
      'pagesetting.title-and-description',
      false
    >;
    breadcrumb: Schema.Attribute.Component<'page-component.breadcrumb1', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CTA: Schema.Attribute.Component<'page-component.breadcrumb1', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPageSettingPageSetting extends Struct.SingleTypeSchema {
  collectionName: 'page_settings';
  info: {
    description: '';
    displayName: 'PageSetting';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Footer: Schema.Attribute.Component<'pagesetting.footer', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    metaTags: Schema.Attribute.String;
    PageCode: Schema.Attribute.RichText;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'title'>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiPeopleWhoContactUsPeopleWhoContactUs
  extends Struct.CollectionTypeSchema {
  collectionName: 'people_who_contact_uses';
  info: {
    description: '';
    displayName: 'People_Who_Contact_Us';
    pluralName: 'people-who-contact-uses';
    singularName: 'people-who-contact-us';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::people-who-contact-us.people-who-contact-us'
    > &
      Schema.Attribute.Private;
...
export interface ApiServicePageServicePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ExperienceAndTestimonial: Schema.Attribute.Component<
      'page-component.experience-and-testimonial',
      false
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Advantages: Schema.Attribute.Component<'pagesetting.advantage', false>;
    content: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    heading: Schema.Attribute.String;
    iconFontAwesome: Schema.Attribute.String;
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    team: Schema.Attribute.Component<'page-component.card1', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::all-page.all-page': ApiAllPageAllPage;
      ...
      'api::people-who-contact-us.people-who-contact-us': ApiPeopleWhoContactUsPeopleWhoContactUs;
